---
name: excel-change-log
description: "Registra alterações, decisões, evidências e pendências de forma auditável."
---

# Excel Change Log

Registra alterações, decisões, evidências e pendências de forma auditável.
...
- Aba/range/componente.
- Tipo de alteração.
- Valor/lógica anterior.
- Valor/lógica nova.
- Motivo.
- Base/evidência.
- Confiança (`CONFIRMED`, `LIKELY`, `REVIEW_REQUIRED`).
- Impacto.

## Regra
Separar claramente:
1. itens alterados com evidência suficiente;
2. itens não alterados por falta de evidência;
3. anomalias já existentes no arquivo original.
