...
description: "Constrói dashboards e páginas executivas orientadas à decisão."
---

# Excel Dashboard Builder

Constrói dashboards e páginas executivas orientadas à decisão.
...
- Título + período/base.
- KPIs principais.
- Tendência temporal ou distribuição relevante.
- Breakdown por fornecedor, categoria, região ou status.
- Top riscos/exceções.
- Observações e premissas.

## Regras
- KPI deve ter definição explícita e ser reconciliável com a base.
- Evitar gráficos redundantes.
- Priorizar leitura em poucos segundos.
- Manter mesma unidade e escala visual entre métricas comparáveis.
- Não usar informação não comprovada pela base.

## Validação
Cada número apresentado no dashboard deve poder ser rastreado até sua fonte e lógica de cálculo.
