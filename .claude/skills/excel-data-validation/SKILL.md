---
name: excel-data-validation
description: "Cria e audita regras de entrada, listas e restrições para prevenir erros."
---

# Excel Data Validation

Cria e audita regras de entrada, listas e restrições para prevenir erros.
...
## Aplicações
- Listas de status, categoria, owner, prioridade.
- Datas dentro de período aceitável.
- Valores numéricos dentro de faixa.
- Obrigatoriedade lógica de campos.

## Regras
- Fontes de dropdown devem ser estáveis e preferencialmente centralizadas em aba de configuração.
- Evitar hardcode duplicado em muitas validações quando range fonte é possível.
- Não aplicar validação sobre células calculadas que o usuário não deve editar.
