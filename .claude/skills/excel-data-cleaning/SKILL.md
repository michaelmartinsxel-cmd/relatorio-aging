...
description: "Limpa e normaliza dados sem apagar informação necessária para auditoria."
---

# Excel Data Cleaning

Limpa e normaliza dados sem apagar informação necessária para auditoria.
...
- Duplicidades reais vs repetições legítimas.
- Variações de nomes/categorias.
- Campos vazios e valores sentinela.

## Regras
- Nunca deduplicar somente porque linhas parecem semelhantes; definir chave de negócio.
- Preservar valor original quando normalização for relevante para auditoria.
- Não inferir categoria crítica sem evidência.
- Gerar lista de registros alterados em limpeza material.
