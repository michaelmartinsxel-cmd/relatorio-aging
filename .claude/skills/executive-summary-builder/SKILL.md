...
description: "Transforma análise de workbook em um resumo executivo conciso, reconciliado e visual."
---

# Executive Summary Builder

Transforma análise de workbook em um resumo executivo conciso, reconciliado e visual.
...
- Total e população relevante.
- Principais KPIs.
- Maiores riscos/exceções.
- Concentrações/top contributors.
- Tendência ou comparação, se suportada.
- Pontos que exigem validação humana.

## Regras
- Nunca colocar no resumo número que não reconcilia com a base.
- Diferenciar fato, interpretação e recomendação.
- Gráficos precisam ter título, unidade e fonte/range rastreável.
- Priorizar materialidade; evitar dezenas de métricas de baixo valor.
