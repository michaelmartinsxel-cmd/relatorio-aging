---
name: excel-pivot-analysis
description: "Planeja e valida análises agregadas equivalentes a tabelas e gráficos dinâmicos."
---

# Excel Pivot Analysis

Planeja e valida análises agregadas equivalentes a tabelas e gráficos dinâmicos.
...
## Regras
- Definir granularidade e dimensão antes da agregação.
- Não somar campos que são taxas/percentuais sem ponderação adequada.
- Tratar blanks e categorias `Unknown` explicitamente.
- Conferir se o total agregado reconcilia com a base.
- Se a API não preservar pivots existentes, não os recriar destrutivamente sem necessidade.

## Saída
Documentar linhas, colunas, filtros, valores e função agregadora de cada análise.
