---
name: excel-reconciliation
description: "Concilia bases, abas ou arquivos e explica diferenças."
---

# Excel Reconciliation

Concilia bases, abas ou arquivos e explica diferenças.
...
## Método
1. Definir chave de conciliação.
2. Normalizar tipos sem destruir os originais.
3. Separar `MATCH`, `MISSING_LEFT`, `MISSING_RIGHT`, `VALUE_MISMATCH`, `DUPLICATE_KEY`.
4. Para matches, comparar campos críticos com tolerância apenas quando definida.
5. Reconciliar quantidade e valor total.

## Saída
Tabela de exceções com chave, valor lado A, valor lado B, diferença, causa provável e status de validação.
