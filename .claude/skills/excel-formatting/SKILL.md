...
description: "Aplica e preserva formatação profissional e semântica visual."
---

# Excel Formatting

Aplica e preserva formatação profissional e semântica visual.
...
## Cobertura
- Fontes, fills, bordas, alinhamentos, quebra de texto.
- Formatos de moeda, percentual, data, número e texto.
- Largura de colunas e altura de linhas.
- Títulos, cabeçalhos, seções e hierarquia visual.

## Regras
- Ao editar template existente, imitar o estilo atual salvo pedido contrário.
- Não usar autofit sem limites em colunas textuais extensas.
- Não alterar formato numérico de valores financeiros sem necessidade.
- Evitar excesso de cores, bordas e células mescladas.
- Hierarquia visual deve distinguir título, KPI, header, dados e observações.
