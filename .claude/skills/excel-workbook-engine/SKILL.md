---
name: excel-workbook-engine
description: "Cria, importa, exporta e organiza workbooks mantendo integridade estrutural."
---

# Excel Workbook Engine

Cria, importa, exporta e organiza workbooks mantendo integridade estrutural.
...
## Responsabilidades
- Criar workbook e abas com nomes válidos e únicos.
- Importar workbook existente sem reconstruí-lo desnecessariamente.
- Adicionar, renomear, ordenar ou ocultar abas somente quando necessário.
- Preservar workbook original e salvar saída em arquivo separado por padrão.
- Garantir extensão correta (`.xlsx`; `.xlsm` somente com ferramenta capaz de preservar VBA).
- Evitar remover macros, vínculos ou objetos não suportados.

## Critérios
- Nenhuma aba crítica perdida.
- Nenhum nome duplicado.
- Arquivo exportado reabre corretamente.
- Estrutura pós-exportação compatível com a estrutura planejada.
