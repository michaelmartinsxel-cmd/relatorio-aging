...
description: "Insere, altera, remove, copia, move e consolida dados de maneira segura e vetorizada."
---

# Excel Data Editor

Insere, altera, remove, copia, move e consolida dados de maneira segura e vetorizada.
...
## Regras
- Preferir escrita em blocos 2D.
- Preservar tipos: data como data, número como número, texto como texto.
- Não converter códigos com zeros à esquerda para números.
- Antes de excluir linhas/colunas, verificar fórmulas, gráficos, tabelas e nomes que dependam delas.
- Para inserções, manter alinhamento entre registros e chaves.
- Operações destrutivas exigem cópia ou registro explícito no change log.

## Validação
- Comparar contagem de linhas antes/depois.
- Verificar unicidade da chave esperada.
- Recalcular totais de controle e amostras.
