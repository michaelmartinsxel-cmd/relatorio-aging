---
name: aging-bucket-validation
description: "Valida regras e resultados de buckets de aging."
---

# Aging Bucket Validation

Valida regras e resultados de buckets de aging.
...
## Testes obrigatórios
- Limites inclusivos/exclusivos sem sobreposição.
- Datas exatamente nos limites (0, 1, 30, 31, 60, 61 etc.).
- Datas futuras.
- Due date em branco.
- Valores negativos/créditos.
- `as_of_date` histórica.
- Soma dos buckets vs total.

## Resultado
Emitir tabela de testes de fronteira e apontar qualquer conflito com a nomenclatura do workbook.
