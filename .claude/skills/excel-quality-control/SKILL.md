---
name: excel-quality-control
description: "É a barreira final de qualidade antes da entrega."
---

# Excel Quality Control

É a barreira final de qualidade antes da entrega.
...
## Gates obrigatórios
### Estrutural
- Arquivo abre/exporta.
- Abas esperadas presentes.
- Tabelas/names/gráficos essenciais preservados.

### Fórmulas
- Scan por `#REF!`, `#DIV/0!`, `#VALUE!`, `#NAME?`, `#N/A`.
- Fórmulas críticas inspecionadas.
- Totais reconciliados.

### Dados
- Contagens plausíveis.
- Chaves e duplicidades verificadas.
- Datas e tipos consistentes.

### Visual
- Ranges principais renderizados quando necessário.
- Gráficos não vazios.
- Conteúdo legível e sem sobreposição.
...
## Resultado
Somente marcar como `FINAL` quando todos os gates aplicáveis passarem. Caso contrário, entregar como `DRAFT/REVIEW_REQUIRED` e indicar exatamente o motivo.
