...
description: "Aplica sinalização visual baseada em regras objetivas e auditáveis."
---

# Excel Conditional Formatting

Aplica sinalização visual baseada em regras objetivas e auditáveis.
...
- Data bars e escalas quando adequadas.

## Regras
- Fórmula deve ser relativa à primeira célula do range.
- Não sobrepor dezenas de regras conflitantes.
- Cor não pode ser a única informação quando o status também pode ser textual.
- Validar visualmente ao menos uma célula que deve ativar e outra que não deve ativar a regra.
