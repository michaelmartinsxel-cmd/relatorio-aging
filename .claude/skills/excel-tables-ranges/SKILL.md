---
name: excel-tables-ranges
description: "Gerencia tabelas estruturadas, ranges, nomes e referências de forma consistente."
---

# Excel Tables & Ranges

Gerencia tabelas estruturadas, ranges, nomes e referências de forma consistente.
...
## Regras
- Toda tabela deve ter nome único e estável.
- Cabeçalhos devem ser únicos, legíveis e não vazios.
- Expandir tabela quando novos registros fizerem parte do mesmo dataset.
- Não deixar totais/gráficos apontando para intervalos antigos após expansão.
- Preferir ranges nomeados para parâmetros globais importantes.

## Validação
- Confirmar quantidade de linhas/colunas da tabela.
- Confirmar que fontes de gráfico/pivot usam a região correta.
- Verificar nomes definidos quebrados.
