---
name: excel-render-validation
description: "Verifica visualmente se sheets, gráficos e dashboards renderizam corretamente."
---

# Excel Render Validation

Verifica visualmente se sheets, gráficos e dashboards renderizam corretamente.
...
## Obrigatório quando
- Gráficos foram criados ou alterados.
- Dashboard/resumo executivo foi alterado.
- Layout, merge, largura ou altura foram alterados significativamente.

## Validar
- Conteúdo não cortado.
- Headers legíveis.
- Gráficos com dados visíveis.
- Legend/títulos não sobrepostos.
- Objetos não cobrindo dados.
- Escalas e números coerentes.
- Ausência de áreas inesperadamente vazias.

Renderização vazia ou incorreta é falha de entrega, mesmo que o XML do arquivo pareça válido.
