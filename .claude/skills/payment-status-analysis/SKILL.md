---
name: payment-status-analysis
description: "Valida coerência entre status de pagamento, vencimento, valor e demais indicadores."
---

# Payment Status Analysis

Valida coerência entre status de pagamento, vencimento, valor e demais indicadores.
...
## Checks
- Item marcado como pago mas com saldo aberto relevante.
- Item vencido marcado como current indevidamente.
- Status vazio.
- Data de pagamento anterior à emissão quando não explicável.
- Pagamento parcial tratado como total.
- Créditos/estornos confundidos com pagamentos.

## Saída
Lista de exceções com severidade, regra violada e evidência disponível.
